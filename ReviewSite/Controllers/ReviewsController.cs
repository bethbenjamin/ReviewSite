...
namespace ReviewSite.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewID,ArriveDate,DepartDate,Comment,Clean,PetFriendly,Pool,OnSiteDining,HouseKeeping,Concierge,NearBeach,BeachMiles,NearMountain,MountainMiles,BikesAvailable,ManyBikes,CategoryID")] Review review)
        {
